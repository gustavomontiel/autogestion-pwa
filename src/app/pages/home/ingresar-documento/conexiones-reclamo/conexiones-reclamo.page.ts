...
@Component({
  selector: 'app-conexiones-reclamo',
  templateUrl: './conexiones-reclamo.page.html',
  styleUrls: ['./conexiones-reclamo.page.scss']
})
export class ConexionesReclamoPage implements OnInit {
  ...
  SeleccionarConexion(conexion: IntConexionesDeuda): void {
    ...
    this.router.navigate([rutas.GENERAR_RECLAMO], {
